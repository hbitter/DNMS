...
#define SOFTWARE_VERSION "DNMS Version 2.1.5"  // Version 2.1 for Teensy4 with USB as Audio Device
...
*/
#define number_of_loops 12        // number of 2,9ms loops (128 PCM values in a block by 44,1 kHz
  ...
  void i2c_receive_from_master(int num_bytes) {
    ...
    switch (command_received) {
      ...
      case 4: // Read Data (Leq) Ready
        i2c_state = E_I2C_READ_DATA_READY;
        break;
