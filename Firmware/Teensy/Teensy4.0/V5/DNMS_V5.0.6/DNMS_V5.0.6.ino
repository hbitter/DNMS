...
#define SOFTWARE_VERSION "DNMS Version 5.0.6"  // Version 5.0.6 for Teensy4 and IM72D128 micro based on FFT
/**********************************************************************************
 *                                                                                *
...
//      Serial.println("calculate_leq");
      ...
      Serial.print("LZeq: "); Serial.print(last_leq_g_Z);
      Serial.print("  LAeq: "); Serial.println(last_leq_g_A);     
//      Serial.print("last_leq_freq_band_g_A 315:"); Serial.println(last_leq_freq_band_g_A[13]);
//      Serial.print("last_leq_freq_band_g_A 400:"); Serial.println(last_leq_freq_band_g_A[14]);     
      calculate_leq = false;
      data_ready = 1;
    }
...
//      Serial.println("calculate_leq_2nd");
      ...
      Serial.print("LZeq_2nd: "); Serial.print(last_leq_g_Z_2nd);
      Serial.print("  LAeq_2nd: "); Serial.println(last_leq_g_A_2nd);

    //  Serial.print("last_leq_freq_band_g_A_2nd 315:"); Serial.println(last_leq_freq_band_g_A_2nd[13]);
    //  Serial.print("last_leq_freq_band_g_A_2nd 400:"); Serial.println(last_leq_freq_band_g_A_2nd[14]);
    //  Serial.print("last_leq_freq_band_g_A_2nd 1000:"); Serial.println(last_leq_freq_band_g_A_2nd[18]);
