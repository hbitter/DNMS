 ...
 *                                                                      *
    ...
    and Invensense microphone ICS-43434, PDM output via ADAU7002ACBZ to I²S 
    input of Teensy4
...
#define SOFTWARE_VERSION "DNMS Version t.5.4"  // standalone testprogram for Teensy4 and ICS-43434 micro based on FFT
/**********************************************************************************
 *                                                                                *
...
#define window 0.3750  // Hanning
  ...
  Serial.println(" "); Serial.print("Version: "); Serial.print(SOFTWARE_VERSION); Serial.println("  for ICS-43434 microphone");
...
//    if (calculate_leq) {
      ...
      if(number_of_calc_periods >= 4) {  // Output of 1/3 Octaves only if output period is >= 500ms
        Serial.print(",");
        for (i = 1; i < 14; i++) {
