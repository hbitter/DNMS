...
#define SOFTWARE_VERSION "DNMS Version 1.0.4"  // its for Teensy4 Version 1.0 without USB-Audio
...
// An array to hold the 16 frequency bands for fft
float level[16];
float scale = 50;
uint16_t fft_loop_cnt = 0;
