...
#define SOFTWARE_VERSION "DNMS Version t.2.4"  // its for Teensy4 without USB-Audio based on FP32 audio lib
...
#define output_loop_time 5000   // Ausgabe der aktuelle LAeq, LAmin und LAmax Werte alle 5000 ms - 5s
...
void setup() {
  ...
  Serial.println(" "); Serial.println("Teensy4.0 test program version is DNMS_Vt.2.4");
  Serial.println(" "); Serial.println("test Teensy4.0 microphone connection and LAeq calculation");
