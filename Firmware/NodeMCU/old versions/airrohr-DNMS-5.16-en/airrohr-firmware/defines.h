...
#define LEN_CFG_STRING 49
#define LEN_CFG_PASSWORD 49

#define LEN_NTP_1 49
#define LEN_NTP_2 49

#define LEN_WLANSSID 49				// credentials for wifi connection

#define LEN_WWW_USERNAME 49			// credentials for basic auth of server internal website

#define LEN_FS_SSID 49				// credentials for sensor access point mode

#define LEN_DNMS_CORRECTION 8
#define LEN_TEMP_CORRECTION 8
#define LEN_HEIGHT_ABOVE_SEALEVEL 8

#define LEN_SENSEBOXID 49

#define LEN_HOST_INFLUX 49
#define LEN_URL_INFLUX 49
#define LEN_USER_INFLUX 49
#define LEN_PASS_INFLUX 49
#define LEN_MEASUREMENT_NAME_INFLUX 49

#define LEN_HOST_MQTT 49
#define LEN_MEASUREMENT_NAME_MQTT 49
#define LEN_USER_MQTT 49
#define LEN_PASS_MQTT 49
#define LEN_MQTT_MAIN_TOPIC 49

#define LEN_HOST_CUSTOM 49
#define LEN_URL_CUSTOM 49
#define LEN_USER_CUSTOM 49
...
//   - if JTAG debugging shall be used100
