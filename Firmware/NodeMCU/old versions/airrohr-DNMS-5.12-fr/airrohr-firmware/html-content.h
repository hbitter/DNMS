...
const char WEB_PAGE_FOOTER[] PROGMEM = "<br/><br/>"
		...
		"&copy; Open Knowledge Lab Stuttgart a.o. (Code for Germany)</a>&nbsp;&nbsp("
                "<a href='https://github.com/hbitter/DNMS/issues' target='_blank' rel='noreferrer'>" INTL_REPORT_ISSUE "</a>"
...
const char WEB_BR_B[] PROGMEM = "</b><br/>";
...
const char WEB_SENSORCOMMUNITY[] PROGMEM = "<a target='_blank' href='https://sensor.community/de/'>Sensor.Community</a>";
const char WEB_HTTPS[] PROGMEM = "HTTPS";
const char WEB_TLS[] PROGMEM = "TLS";
