...
// increment on change
#define SOFTWARE_VERSION_STR "NRZ-2021-134-DNMS-3.2"
...
static void initDNMS()
{
  ...
  int int_version;
    ...
    if (int_version == 4)
    {
      ...
      debug_outln_info(F("DNMS 2nd interval is available in the DNMS firmware"));
      debug_outln_info(F("but not supported by this NodeMCU firmware! You have to use"));
      debug_outln_info(F("a different NodeMCU firmware, if you want this feature."));             
    }
	}
}
