...
enum ConfigShapeId {
  ...
  Config_ntp_1,
  Config_ntp_2,
	Config_dnms_read_din01,
  Config_dnms_din01_pin,
};
...
static constexpr char CFG_KEY_DNMS_MICRO_TYPE[] PROGMEM = "dnms_micro_type";
...
static constexpr char CFG_KEY_DNMS_READ_DIN01[] PROGMEM = "dnms_read_din01";
static constexpr char CFG_KEY_DNMS_DIN01_PIN[] PROGMEM = "dnms_din01_pin";
...
static constexpr ConfigShapeEntry configShape[] PROGMEM = {
  ...
  { Config_Type_UInt, 0, CFG_KEY_DNMS_MICRO_TYPE, &cfg::dnms_micro_type },	
  ...
  { Config_Type_Bool, 0, CFG_KEY_DNMS_READ_DIN01, &cfg::dnms_read_din01 },
  { Config_Type_UInt, 0, CFG_KEY_DNMS_DIN01_PIN, &cfg::dnms_din01_pin },	
};
