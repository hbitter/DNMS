...
constexpr unsigned XXXLARGE_STR = 4096-1;
//constexpr unsigned XXXLARGE_STR = 5120-1;
...
extern void add_Value2Json2(String& res, const __FlashStringHelper* type, const String& value);
extern void add_Value2Json2(String& res, const __FlashStringHelper* type, const __FlashStringHelper* debug_type, const float& value);
...
extern void debug_outln_error(const String& text);
