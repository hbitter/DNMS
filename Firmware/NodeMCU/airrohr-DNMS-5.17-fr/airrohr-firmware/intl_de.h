...
#define INTL_WIFI_WITH_PWD "Mit WLAN Passwort"
...
const char INTL_DNMS_MICROPHONE[] PROGMEM = "Auswahl Mikrofon bzw. Gehäuse oder Frequenzgangkorrektur - folgende Möglichkeiten";
const char INTL_DNMS_MICROPHONE2[] PROGMEM = "1 = ICS-43434, 2= IM72D128, 3 = IM72D128 mit DLR Gehäuse, 4 = ICS-43434 ohne Frequenzgangkorrektur, 5 = IM72D128 ohne Frequenzgangkorrektur:";
const char INTL_DNMS_MICRO_TYPE[] PROGMEM = "Welches Mikrofon?";
...
const char INTL_DNMS_READ_DIN01[] PROGMEM = "Digitalen Eingang (DIN01) abfragen und innerhalb 2. Messintervall an InfluxDB/MQTT übertragen";
const char INTL_DNMS_DIN01_PIN[] PROGMEM = "GPIO Pin der abgefragt wird";
...
const char INTL_NTP_SERVER_1[] PROGMEM = "NTP Zeitserver 1";
const char INTL_NTP_SERVER_2[] PROGMEM = "NTP Zeitserver 2";
const char INTL_NTP_SERVER_TEXT[] PROGMEM = "NTP Zeitserver ändern";
...
const char INTL_MQTT_MEASUREMENT[] PROGMEM = "MQTT Messung";
const char INTL_MQTT_MAIN_TOPIC[] PROGMEM = "MQTT main topic";
const char INTL_ID_AS_MQTT_SUB_TOPIC[] PROGMEM = "Sensor ID als MQTT Sub Topic";
const char INTL_INFLUX_MEASUREMENT[] PROGMEM = "Messung";
...
const char INTL_TIME_TO_FIRST_MEASUREMENT[] PROGMEM = "Noch {v} Sekunden bis zur ersten Messung (1. Messintervall).";
const char INTL_TIME_SINCE_LAST_MEASUREMENT[] PROGMEM = " Sekunden seit der letzten Messung (1. Messintervall).";
