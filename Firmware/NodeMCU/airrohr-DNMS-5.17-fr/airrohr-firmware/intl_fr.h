...
const char INTL_CAREFUL_ATTENTION[] = "Veuillez vérifier attentivement les changements des broches I²C!";
const char INTL_SAVE[] PROGMEM = "Enregistrer";
const char INTL_SENSORS[] PROGMEM = "Capteurs";
const char INTL_START[] PROGMEM = "Après un redémarrage:";
const char INTL_START_ZWEI[] PROGMEM = "Attention! L'accès au serveur web local n'est pas possible en attendant !";
const char INTL_START_ON_FULL_MINUTE[] PROGMEM = "Démarrer les mesures à la minute complète";
const char INTL_START_ON_FULL_HOUR[] PROGMEM = "Démarrer les mesures à l'heure complète";
const char INTL_SENSOR_CYCLIC_RESTART[] PROGMEM = "Redémarrage cyclique du capteur";
const char INTL_SENSOR_CYCLIC_RESTART_TIME[] PROGMEM = "Temps de cycle pour le redémarrage en h";
const char INTL_DNMS_SENSOR[] PROGMEM = "DNMS capteur de bruit";
...
const char INTL_SCD4X_LOW_POWER[] PROGMEM = "SCD4X mesures avec moins de consommation d'énergie";
...
const char INTL_DNMS_SPECTRUM[] PROGMEM = "DNMS pondération A du spectre de fréquence";
const char INTL_DNMS_SPECTRUM_Z[] PROGMEM = "DNMS pondération Z du spectre de fréquence";
const char INTL_DNMS_2nd_INTERVAL[] PROGMEM = "DNMS 2. intervalle de mesure (LAeq)";
const char INTL_DNMS_2nd_INTERVAL_Z[] PROGMEM = "DNMS 2. intervalle de mesure (LZeq)";
const char INTL_DNMS_2nd_SPECTRUM[] PROGMEM = "DNMS 2. intervalle de mesure pondération A du spectre de fréquence";
const char INTL_DNMS_2nd_SPECTRUM_Z[] PROGMEM = "DNMS 2. intervalle de mesure pondération Z du spectre de fréquence";
const char INTL_DNMS_2nd_INTERVAL_TIME[] PROGMEM = "DNMS 2. intervalle de mesure en secondes";
const char INTL_DNMS_2nd_THRESHOLD[] PROGMEM = "DNMS 2. intervalle de mesure valeur seuil LAeq&nbsp;in&nbsp;dB(A)";
const char INTL_DNMS_2nd_NUMBER_MEASUREMENTS[] PROGMEM = "DNMS 2. intervalle de mesure # mesures après dépassement";
const char INTL_DNMS_2nd_SWITCH_OUTPUT[] PROGMEM = "DNMS 2. intervalle de mesure sortie de commutation en cas de dépassement";
const char INTL_DNMS_2nd_GPIO_PIN[] PROGMEM = "DNMS 2. intervalle de mesure broche GPIO commutée";
const char INTL_DNMS_CORRECTION[] PROGMEM = "Valeur corrigée en dB(A)";
const char INTL_DNMS_MICROPHONE[] PROGMEM = "Sélection du microphone ou du boîtier, ou correction de la réponse en fréquence - options suivantes";
const char INTL_DNMS_MICROPHONE2[] PROGMEM = "1 = ICS-43434, 2= IM72D128, 3 = IM72D128 avec le boîtier DLR, 4 = ICS-43434 sans correction de réponse en fréquence, 5 = IM72D128 sans correction de réponse en fréquence:";
const char INTL_DNMS_MICRO_TYPE[] PROGMEM = "Quel micro?";
...
const char INTL_DNMS_READ_DIN01[] PROGMEM = "Lire l'entrée numérique (DIN01) et transmettre via le 2ème intervalle à InfluxDB/MQTT";
const char INTL_DNMS_DIN01_PIN[] PROGMEM = "Broche GPIO à vérifier";
...
const char INTL_POWERSAVE [] PROGMEM ="coffre-fort électrique?";
...
const char INTL_NTP_SERVER_1[] PROGMEM = "Serveur NTP 1";
const char INTL_NTP_SERVER_2[] PROGMEM = "Serveur NTP 2";
const char INTL_NTP_SERVER_TEXT[] PROGMEM = "Changement de serveur NTP";
...
const char INTL_MQTT_MEASUREMENT[] PROGMEM = "MQTT Mesure";
const char INTL_MQTT_MAIN_TOPIC[] PROGMEM = "MQTT main topic";
const char INTL_ID_AS_MQTT_SUB_TOPIC[] PROGMEM = "ID du capteur en tant que sous-sujet MQTT";
const char INTL_INFLUX_MEASUREMENT[] PROGMEM = "Mesure";
...
const char INTL_TIME_TO_FIRST_MEASUREMENT[] PROGMEM = "Encore {v} secondes avant la première mesure (1er intervalle de mesure).";
const char INTL_TIME_SINCE_LAST_MEASUREMENT[] PROGMEM = " secondes écoulées depuis la dernière mesure (1er intervalle de mesure).";
...
const char INTL_VOC[] PROGMEM = "Substances organiques volatiles VOC";
const char INTL_NOX[] PROGMEM = "Oxydes d'azote NOx";
