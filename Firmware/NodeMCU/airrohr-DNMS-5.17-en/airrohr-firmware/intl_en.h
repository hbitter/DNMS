...
const char INTL_SENSOR_CYCLIC_RESTART[] PROGMEM = "cyclic restart of sensor";
...
const char INTL_DNMS_MICROPHONE[] PROGMEM = "Selection of microphone or housing or frequency response correction - following options";
const char INTL_DNMS_MICROPHONE2[] PROGMEM = "1 = ICS-43434, 2= IM72D128, 3 = IM72D128 with DLR housing, 4 = ICS-43434 no frequency response correction, 5 = IM72D128 no frequency response correction:";
const char INTL_DNMS_MICRO_TYPE[] PROGMEM = "Which microphone?";
...
const char INTL_DNMS_READ_DIN01[] PROGMEM = "Read digital input (DIN01) and transmit via 2nd interval to InfluxDB/MQTT";
const char INTL_DNMS_DIN01_PIN[] PROGMEM = "GPIO Pin to check";
