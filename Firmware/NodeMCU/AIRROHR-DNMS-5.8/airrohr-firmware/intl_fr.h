...
const char INTL_MQTT_MEASUREMENT_TEXT[] PROGMEM = "If data is being transferred from MQTT Broker to an InfluxDB, please enter or change the InfluxDB 'measurement' in InfluxDB";
const char INTL_MQTT_MAIN_TOPIC[] PROGMEM = "MQTT main topic";
const char INTL_ID_AS_MQTT_SUB_TOPIC[] PROGMEM = "ID as MQTT sub topic";
