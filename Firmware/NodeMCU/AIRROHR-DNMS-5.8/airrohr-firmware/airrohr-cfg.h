...
static constexpr char CFG_KEY_DB_NAME_INFLUX[] PROGMEM = "db_name_influx";
...
static constexpr ConfigShapeEntry configShape[] PROGMEM = {
  ...
  { Config_Type_String, sizeof(cfg::db_name_influx)-1, CFG_KEY_DB_NAME_INFLUX, cfg::db_name_influx },
