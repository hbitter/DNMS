...
F 3 "" H 5500 6400 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 8150 4500 2    50   BiDi ~ 0
SDA_Ex
...
U 1 1 5E7FF7F9
P 9350 4400
F 0 "#PWR0124" H 9350 4150 50  0001 C CNN
...
U 1 1 5E800639
P 8800 4700
F 0 "#PWR0125" H 8800 4550 50  0001 C CNN
...
U 1 1 5E7FD347
P 7750 4600
F 0 "J5" H 7807 5167 50  0000 C CNN
F 1 "RJ12" H 7807 5076 50  0000 C CNN
F 2 "Connector_RJ:RJ12_Amphenol_54601" V 7750 4625 50  0001 C CNN
F 3 "~" V 7750 4625 50  0001 C CNN
	1    7750 4600
	1    0    0    -1  
$EndComp
...
F 1 "P82B715DR" H 8100 3840 50  0000 C CNN
F 2 "P82B715:SOIC8" H 8100 3150 50  0001 L BNN
...
U 1 1 5EC12774
P 8500 2550
F 0 "#PWR0108" H 8500 2400 50  0001 C CNN
...
U 1 1 5EC12EF1
P 8100 3650
F 0 "#PWR0111" H 8100 3400 50  0001 C CNN
...
SCL_Ex
Text GLabel 7500 3150 0    50   Output ~ 0
SCL
...
F 3 "" H 4950 900 50  0001 C CNN
	...
	1    0    0    -1  
$EndComp
Text GLabel 8150 5750 2    50   BiDi ~ 0
SDA_Ex
Text GLabel 8150 5850 2    50   Output ~ 0
SCL_Ex
Wire Wire Line
	9350 5550 9350 5650
$Comp
...
U 1 1 5F451BE6
P 9350 5650
F 0 "#PWR0115" H 9350 5400 50  0001 C CNN
...
U 1 1 5F451BF3
P 8800 5950
F 0 "#PWR0127" H 8800 5800 50  0001 C CNN
F 1 "+5V" H 8815 6123 50  0000 C CNN
...
Wire Wire Line
	8150 5650 9350 5650
Text Notes 8700 6400 2    50   ~ 0
I²C-Bus-Extended connection\nvia RJ12 connector
$Comp
L Connector:RJ12 J6
U 1 1 5F451C02
P 7750 5850
F 0 "J6" H 7807 6417 50  0000 C CNN
F 1 "RJ12" H 7807 6326 50  0000 C CNN
F 2 "Connector_RJ:RJ12_Pulse_E5566Q0LK22L" V 7750 5875 50  0001 C CNN
F 3 "~" V 7750 5875 50  0001 C CNN
	1    7750 5850
	1    0    0    -1  
$EndComp
